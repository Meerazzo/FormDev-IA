...
class Settings(BaseSettings):
    ...
    RAG_ANSWERABILITY_GATE_ENABLED: bool = True
    RAG_ANSWERABILITY_GATE_CONFIDENCE_LEVELS: str = "medium"
    RAG_ANSWERABILITY_GATE_MAX_CHUNKS: int = 5
    RAG_ANSWERABILITY_GATE_MAX_CONTEXT_CHARS: int = 4000
